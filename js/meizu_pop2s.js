 ...
 var  delivery_address_bo=true;
  $('.delivery_address').click(function(){
   ...
   $('.li_2').click(function(e){
       console.log()
      if($(this).index()==0){
          $('.small_1 img').attr('src','./img/meizu_pop2/A1.jpg');
          $('#meizu17_big').html($('.small_1').html());
          $('.small_2 img').attr('src','./img/meizu_pop2/A2.jpg');
          $('.small_3 img').attr('src','./img/meizu_pop2/A3.jpg');
          $('.small_4 img').attr('src','./img/meizu_pop2/A4.jpg');
      }
      if($(this).index()==1){
       $('.small_1 img').attr('src','./img/meizu_pop2/B1.jpg');
         $('#meizu17_big').html($('.small_1').html());
       $('.small_2 img').attr('src','./img/meizu_pop2/B2.jpg');
       $('.small_3 img').attr('src','./img/meizu_pop2/B3.jpg');
       $('.small_4 img').attr('src','./img/meizu_pop2/B4.jpg');
   }
   if($(this).index()==2){
       $('.small_1 img').attr('src','./img/meizu_pop2/C1.jpg');
          $('#meizu17_big').html($('.small_1').html());
          $('.small_2 img').attr('src','./img/meizu_pop2/C2.jpg');
          $('.small_3 img').attr('src','./img/meizu_pop2/C3.jpg');
          $('.small_4 img').attr('src','./img/meizu_pop2/C3.jpg');
   }
   if($(this).index()==3){
       $('.small_1 img').attr('src','./img/meizu_pop2/D1.jpg');
           $('#meizu17_big').html($('.small_1').html());
          $('.small_2 img').attr('src','./img/meizu_pop2/D2.jpg');
          $('.small_3 img').attr('src','./img/meizu_pop2/D3.jpg');
          $('.small_4 img').attr('src','./img/meizu_pop2/D3.jpg');
   }
   })
